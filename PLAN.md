...
- [ ] Drizzle ORM 설치 및 설정
- [ ] DB 스키마 정의 (schema.ts)
  - [ ] users, trading_configs, trading_signals
  - [ ] orders, positions, market_data
  - [ ] backtest_results, simulation_balances
- [ ] 마이그레이션 생성 및 실행
- [ ] Seed 데이터 작성

### 1.3 빗썸 API 연동
- [ ] 빗썸 Public API 클라이언트 구현
  - [ ] 시세 조회 (/public/ticker)
  - [ ] 호가 조회 (/public/orderbook)
  - [ ] 체결 내역 (/public/transaction_history)
  - [ ] 캔들 데이터 (/public/candlestick)
- [ ] 빗썸 Private API 클라이언트 구현
  - [ ] HMAC-SHA512 인증 구현
  - [ ] 잔고 조회 (/info/balance)
  - [ ] 주문 등록 (/trade/place)
  - [ ] 주문 조회/취소
- [ ] WebSocket 연결 관리
  - [ ] wss://pubwss.bithumb.com/pub/ws 연결
  - [ ] 실시간 시세 구독
  - [ ] Heartbeat 구현
  - [ ] 자동 재연결 로직
- [ ] Rate Limiting 처리
...
- [ ] 거래량 분석
  - [ ] 평균 거래량 계산 (20일)
  - [ ] 거래량 급증 감지 (1.5배, 2배, 3배)
  - [ ] 점수화 로직

### 2.3 Signal Generator
- [ ] 지표 통합 분석
  - [ ] 개별 지표 점수 계산
  - [ ] 가중치 적용 (RSI 25%, MACD 30%, Bollinger 20%, 거래량 25%)
  - [ ] 종합 점수 산출 (0-100)
- [ ] 시그널 결정
  - [ ] 70점 이상: 강한 매수
  - [ ] 30-70점: 보유 (중립)
